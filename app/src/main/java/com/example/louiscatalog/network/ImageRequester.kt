package com.example.louiscatalog.network
...
import com.example.louiscatalog.application.LouisCatalogApplication
...
object ImageRequester {
    ...
    init {
        val context = LouisCatalogApplication.instance
